...
randomize = False
stoke_hash = 'dbf245b249ec2898a67be971ed104ee0f173dba7'

def main():
    targets = targetbuild.make_all_from_c("gulwani/gulwani.json")
    ...
    jobs = [{'series': series_id,
              'name': n, 'stoke_hash': stoke_hash, 'target': targets[n],
